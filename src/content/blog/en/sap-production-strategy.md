...
![Diagram comparing SAP production strategies MTS vs. MTO — the difference in lead time and inventory characteristics between the buffet (make-to-stock) and steakhouse (make-to-order) models](/images/sap-production-strategy_en.png)
