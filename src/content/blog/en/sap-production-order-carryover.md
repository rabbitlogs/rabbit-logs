...
![Comparison of SAP production order carryover methods — showing the processing flow of order carryover and WIP carryover side by side](/images/sap-production-order-carryover_en.png)
