---
title: "Why I went back to school: wanting to say in data what I used to say by gut feeling"
mapTitle: "Why I went back to school"
description: "Why a production management practitioner working with SAP and MES transferred into a statistics and data science program at the Korea National Open University. A plain account of wanting to speak about production metrics in data instead of gut feeling."
pubDate: "2026-06-22"
category: "stats"
series: "A SAP practitioner's data studies"
tags: ['Statistics', 'KoreaNationalOpenUniversity', 'TransferStudent', 'DataAnalysis', 'StudyingWhileWorking']
level: "beginner"
essay: true
---
...
This itch became clear once [the SAP stabilization and enhancement project](/en/blog/sap-build-project-difficulty) wrapped up. Once the implementation was done and the system settled in, data I could actually trust started to accumulate. Production, inventory, sales — no longer someone's memory or a spreadsheet note, but numbers sitting inside the system.
...
<!-- Related posts: prerequisite=; related=sap-mrp,sap-build-project-difficulty; deepens= -->
