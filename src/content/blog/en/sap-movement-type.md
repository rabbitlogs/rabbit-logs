...
![Flow diagram showing movement types from 261 (goods issue) to 101 (goods receipt) to 311 (storage location transfer) to 531 (by-product receipt)](/images/sap-movement-type_en.png)
