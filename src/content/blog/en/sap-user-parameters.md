...
![SAP screen with the cursor on a field and the Performance Assistant help window opened via F1](/images/sap-user-parameters-01.jpg)
*Figure 1. Place the cursor on the field you want to fix a value for and press F1 to open the field description*

![SAP Technical Information popup showing the parameter ID (CFV) under the Field Data section](/images/sap-user-parameters-02.jpg)
...
![SU3 user profile maintenance Parameters tab — parameter ID CFV registered with value 100](/images/sap-user-parameters-03.jpg)
