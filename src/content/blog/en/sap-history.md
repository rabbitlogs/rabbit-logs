---
title: "The history of SAP: it all started with a small restaurant"
mapTitle: "The history of SAP"
description: "Five engineers left IBM in 1972 and founded SAP. From R/2 and R/3 to S/4HANA, here's how SAP became the standard for ERP, explained for beginners."
pubDate: "2025-07-16"
category: "project"
series: "Learning SAP through a restaurant"
level: "beginner"
tags: ["SAPProjects", "SAPHistory", "ERP", "SAPBasics"]
---

Hi, this is Rabbit! 🐰

In [SAP for beginners: the integrated brain behind a restaurant kitchen](/en/blog/sap-what-is-sap), we looked at how SAP is "the integrated system that runs a company." But where did this massive system actually come from? Today's a bit of a breather — let's trace SAP back to where it started. Knowing the backstory makes it easier to understand why SAP looks the way it does today.
...
> - It evolved from R/2 to R/3 to [S/4HANA](https://www.sap.com/products/erp/s4hana.html), becoming the global standard for ERP.
...
In a word, early SAP's goal was <strong class="key">real-time</strong> processing. That's why the first product was called RF, later renamed **R/1** — the "R" stands for Real-time.
...
The <strong class="key">real-time</strong> starting point of R/1 has, more than 50 years later, become even faster through in-memory technology. The direction never changed — it just kept accelerating.
...
<!-- Related posts: prerequisite=; related=sap-what-is-sap,sap-modules-guide; deepens= -->
