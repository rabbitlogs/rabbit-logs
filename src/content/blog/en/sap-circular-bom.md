...
![SAP circular BOM rework flow — diagram showing a finished product going through a rework step and returning as the same finished product, and where the "Allow cycles" checkbox sits](/images/sap-circular-bom_en.png)
