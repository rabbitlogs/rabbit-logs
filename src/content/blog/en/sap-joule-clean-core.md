...
![Dependency diagram running from SAP Joule to Clean Core to Z-code cleanup. The goal sits at the top (Joule), but the work has to start at the bottom (Z-code)](/images/sap-joule-clean-core_en.png)
