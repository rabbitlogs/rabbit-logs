...
테스트 5단계의 세 번째, 단위 테스트입니다. [SAP 프로토타입 테스트, 짓기 전에 보는 시범 매장](/blog/sap-prototype-test)로 만들 기능의 모습을 확정했다면, 이제 개발자와 컨설턴트가 각자 '부품'을 만들기 시작합니다. 영업팀을 위한 주문 프로그램, 구매팀의 자동 입고 기능, 회계팀의 특별 리포트까지요.
...
![단위 테스트와 통합 테스트의 차이를 재료 검사와 요리 검사에 비유해 5개 기준으로 비교한 표](/images/sap-unit-test-01.jpg)
*그림 1. 단위 테스트와 통합 테스트의 차이 — 재료 검사와 요리 검사*
...
이렇게 검증된 부품들을 한데 모아 서로 잘 맞물려 돌아가는지 확인하는 것은, 그다음 단계인 통합 테스트의 몫입니다. 😎
