...
- [계획오더와 생산오더, 조리 예정표와 실제 조리 지시의 차이](/blog/sap-planned-vs-production-order)
- [SAP 데이터 필드 이름, 화면 속 외계어를 읽는 법](/blog/sap-field-names)

<!-- 관련글: prerequisite=sap-planned-vs-production-order; related=sap-production-order-status,sap-field-names; deepens= -->
