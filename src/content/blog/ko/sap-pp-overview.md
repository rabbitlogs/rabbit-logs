...
> 💡 **핵심**: BOM과 Routing은 [SAP PP 기준정보](/blog/sap-pp-master-data)에서 더 자세히 다룹니다. PP를 처음 접한다면 해당 글을 먼저 읽는 것을 권장합니다.
...
<!-- 관련글: prerequisite=sap-pp-master-data; related=sap-mrp,sap-mes-role; deepens=sap-planned-vs-production-order -->
