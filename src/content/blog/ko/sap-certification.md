...
![SAP 자격증을 매년 갱신하는 멤버십에 비유한 일러스트, 요리사가 SAP Certification 자격증을 들고 있는 모습](/images/sap-certification-01.jpg)
...
공인 교육 비용은 모듈에 따라 다르지만 보통 **300–500만 원** 수준입니다. 예를 들어 [S/4HANA](https://www.sap.com/products/erp/s4hana.html) 생산관리(PP) 자격증(`C_TS422`)을 준비한다면 관련 아카데미 과정부터 들어야 합니다.
...
> ⚠️ **주의**: 기간 내에 평가를 통과하지 못하면 자격증은 **Expired(만료)** 상태가 되고, 다시 쓰려면 처음부터 시험을 봐야 합니다.
...
예전에 사둔 응시권(바우처)도 새 시험에 그대로 쓸 수 있습니다. 다만 시험 방식이 바뀌면서 신청 경로가 달라졌으니, 실제 시험이 어떻게 진행되는지는 [SAP 자격증 시험, 필기에서 실습 주방으로 바뀐 시험장](/blog/sap-exam-format) 글에서 따로 정리했습니다.
...
<!-- 관련글: prerequisite=; related=; deepens=sap-exam-format,sap-cpim -->
