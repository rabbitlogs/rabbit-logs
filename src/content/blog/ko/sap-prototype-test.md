...
![프로토타입 테스트의 3단계 흐름 - 시범 매장 오픈, 현업이 직접 확인, 설계 확정·수정을 화살표로 연결한 도식](/images/sap-prototype-test-01.jpg)
*그림 1. 프로토타입 테스트의 흐름 — 짓기 전에 만져보고 고친다*
...
이렇게 기능의 큰 방향을 확정하고 나면, 그다음은 가장 작은 단위부터 하나하나 검사하는 단위 테스트의 영역입니다. 😎

**더 읽어보기**

- [SAP Fit/Gap 분석, 표준과 우리 매장 사이의 간격 재기](/blog/sap-fit-gap)

<!-- 관련글: prerequisite=sap-fit-gap; related=; deepens= -->
