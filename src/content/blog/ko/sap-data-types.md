...
SAP에서도 똑같습니다. <strong class="key">컨피규레이션</strong>, **마스터**, **트랜잭션**이라는 세 가지 데이터 유형 중 어디서 꼬였는지를 구분하지 못하면, 오류 하나를 붙잡고 엉뚱한 곳만 헤매게 됩니다. 이 구분이 SAP 초보와 중수를 가르는 첫 번째 기준이라고 해도 과언이 아닙니다.
