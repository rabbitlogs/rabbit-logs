...
**넷째, 가볍고 빠릅니다.** 최신 [Fiori](https://www.sap.com/products/technology-platform/fiori.html) 스타일 테마는 세련된 만큼 시스템 자원을 더 씁니다. 그래서 화면을 이동하거나 메뉴를 클릭할 때 미세하게 느려지기도 합니다. 시그니처 테마는 가장 가볍고 반응이 빨라서, T-code로 화면을 빠르게 전환하는 작업이 많은 실무자에게 유리합니다.
...
![SAP 화면 좌측 상단 아이콘을 눌러 옵션 메뉴로 들어가는 화면](/images/sap-signature-theme-02.jpg)
...
![비주얼 디자인 테마 설정에서 SAP Signature Theme를 선택하는 화면](/images/sap-signature-theme-02.jpg)
