...
사실 이 단어들은 독일어 약어라서 낯설 뿐입니다. <strong class="key">필드 이름</strong>의 규칙만 알면, 처음 보는 화면도 더는 막막하지 않습니다. 오늘은 [PP(생산계획) 모듈](/blog/sap-pp-master-data)과 관련 깊은 **AUFK 테이블**을 중심으로, SAP 필드 이름을 레시피 재료명에 빗대어 풀어드립니다.
...
| 필드명 | 독일어 원어 | 뜻 | 레스토랑 비유 |
|---|---|---|---|
| `ERNAM` / `ERDAT` | Erfasst von / am | 생성자 / 생성일 | 레시피를 처음 쓴 셰프 / 그 날짜 |
| `AENAM` / `AEDAT` | Geändert von / am | 변경자 / 최종변경일 | 레시피를 마지막으로 고친 셰프 / 그 날짜 |
...
- [SAP 데이터 유형: 컨피규레이션, 마스터, 트랜잭션](/blog/sap-data-types)
- [SAP T-CODE 사용법: 입력부터 단축 명령어·즐겨찾기까지](/blog/sap-tcode-basics)

<!-- 관련글: sap-data-types, sap-tcode-basics -->
